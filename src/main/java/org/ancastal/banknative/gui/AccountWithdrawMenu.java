...
public class AccountWithdrawMenu extends Menu {
	...
	public AccountWithdrawMenu(Player viewer, Account account, String bankName, Database database) {
		...
		this.confirmButton = new Button() {
			...
			public void onClickedInMenu(Player player, Menu menu, ClickType click) {
				AccountWithdrawMenu.this.restartMenu();
